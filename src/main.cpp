...
unsigned int nStakeMinAge = 60 * 60 * 24 * 3 ; // minimum age for coin age
unsigned int nStakeMaxAge = 60 * 60 * 24 * 9 ; // stake age of full weight
unsigned int nStakeTargetSpacing = 1 * 30; // DIFF: 1-minute block spacing
int64 nChainStartTime = 1397826680;
int64 nNextStageTime = 1429286400;
...
static int64 nRewardCoinYearMin = 10 * CENT;  // creation amount per coin-year
...
// CF: increasing Nfactor gradually
...
int64 GetProofOfStakeReward(unsigned int nTime, int64 nCoinAge)
{
    int64 nRewardCoinYear = nRewardCoinYearMin;
     if(nTime >= nNextStageTime){
         ...
         nRewardCoinYear = std::pow(0.95, months + 1) *10;
...
bool CBlock::ConnectBlock(CTxDB& txdb, CBlockIndex* pindex, bool fJustCheck)
{
    ...
    bool fEnforceBIP30 = true; // Always active in CoffeeCoin
    bool fStrictPayToScriptHash = true; // Always active in CoffeeCoin
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "XHU5NTdGXHU2Qzk5XHU5MDFBXHU2NjEzXHU4RjZGXHU0RUY2XHU3OUQxXHU2MjgwXHU2NzA5XHU5NjUwXHU1MTZDXHU1M0Y4  t0 day";
        CTransaction txNew;
        ...
        assert(block.hashMerkleRoot == uint256("0x5023a116822b3f9e0c99b9c5b217981d053e2a5a19e4f3471cc65722908f0098"));
        block.print();
