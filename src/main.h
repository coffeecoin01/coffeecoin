...
static const uint256 hashGenesisBlockOfficial("0xf2219af534446bef76ae881535aa1959116f09dcba02ce59bab258af7e3b602d");
...
// coffeecoin: calculate Nfactor using timestamp
...
public:
    ...
    {
        // Protocol switch to support p2pool at coffeecoin block #9689
        //if (nHeight >= 9689)
        {
        ...
        /*// Before coffeecoin block #9689 - old protocol
